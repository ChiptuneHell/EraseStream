"""Warm interactive-figure theme for the long-video StreamErase demo.
...
THEME_DIR = ROOT / "web" / "static_long_figure"
TEMPLATE_DIR = ROOT / "web" / "templates_long_figure"
demo.app.template_folder = str(TEMPLATE_DIR)
demo.app.add_url_rule(
    "/figure_static/<path:filename>",
    endpoint="figure_static",
