"""Light-themed entry point for the long-video web demo.
...
LIGHT_TEMPLATE_DIR = ROOT / "web" / "templates_long_light"
LIGHT_STATIC_DIR = ROOT / "web" / "static_long_light"

demo.app.template_folder = str(LIGHT_TEMPLATE_DIR)
demo.app.add_url_rule(
    "/light_static/<path:filename>",
    endpoint="light_static",
